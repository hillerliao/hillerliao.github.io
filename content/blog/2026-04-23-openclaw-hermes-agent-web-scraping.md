...
Date: 2026-04-23
Category: AI
Tags: OpenClaw, Hermes Agent, AI, 网页抓取, 智能体
Slug: openclaw-hermes-agent-web-scraping
Author: hillerliao
Summary: 对比 OpenClaw 和 Hermes Agent 在抓取需要 JS 渲染的网页时的表现，解析 headless Chromium 与普通 HTTP 请求的差异。
